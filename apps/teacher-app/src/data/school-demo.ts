  ...
  return {
    ...
    conversations: [
      ...
      },
      {
        ...
        tags: ["Academic"],
        time: "11:21",
        subject: "Form 3 set texts",
        preview: "Can we confirm the poetry anthology for next term?",
        tab: "Staff",
      },
      {
        id: "c6",
        ...
        preview: "The Form 4 bunsen stock is down to two working sets.",
        tab: "Staff",
      },
      {
        id: "c7",
        ...
        preview: "Is it possible to split this term's balance over six weeks?",
        tab: "Parent → Headmaster",
      },
      {
        id: "c8",
        from: "Blessing Chirwa",
        role: "Form teacher",
        tags: ["Pastoral"],
        time: "Yesterday",
        subject: "Form 1 Blue trip",
        preview: "Permission slips are in — two families still to confirm.",
        tab: "Staff",
      },
      {
        id: "c9",
